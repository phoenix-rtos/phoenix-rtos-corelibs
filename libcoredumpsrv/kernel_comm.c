...
int coredump_waitForCrash(coredump_general_t *crashInfo)
{
	msg_t msg;
...
int coredump_getThreadContext(int tid, coredump_thread_t *resp)
{
	msg_t msg;
	...
	msg.i.data = &req;
	msg.o.size = sizeof(coredump_thread_t) + sizeof(cpu_context_t);
	msg.o.data = resp;
...
int coredump_getMemList(size_t bufSize, coredump_memseg_t *resp)
{
	msg_t msg;
	coredump_req_t req = {
